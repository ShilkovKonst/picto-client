...
export async function GET(req, { params }) {
  ...
  try {
    return await handleGetAllByTypeId(id, accessToken, csrfToken);
  } catch (error) {
...
async function handleGetAllByTypeId(id, accessToken, csrfToken) {
  const response = await fetch(
    `${process.env.SERVER_BASE_URL}/pictograms/type/${id}`,
    {
      headers: {
