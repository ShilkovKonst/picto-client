...
const PasswordDesc = ({ defaultValue, invalid }) => {
  return (
    <div
      className={`hidden peer-focus:block absolute bottom-0 top-12 bg-white text-xs text-left`}
    >
      <div className="bg-white z-10 rounded-lg border border-primary cursor-default p-1">
